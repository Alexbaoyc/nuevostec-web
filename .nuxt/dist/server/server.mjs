...
import { $fetch } from "/root/.openclaw/workspace/nuevostec-web/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/root/.openclaw/workspace/nuevostec-web/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/root/.openclaw/workspace/nuevostec-web/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/root/.openclaw/workspace/nuevostec-web/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu } from "/root/.openclaw/workspace/nuevostec-web/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "/root/.openclaw/workspace/nuevostec-web/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-B__dPvbO.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BmbpZS-s.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-bQu56N2o.js"));
