import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/h3/dist/index.mjs';
import { joinRelativeURL, joinURL } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/ufo/dist/index.mjs';
...
import { renderToString } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/devalue/index.js';
import { walkResolver } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/unhead/dist/utils.mjs';
import { isRef, toValue, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/vue/index.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"成都瑞纳致一网络科技有限公司 - 企业出海、企业上云、全球贸易洞察"},{"name":"theme-color","content":"#0A0F1E"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.svg"},{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Noto+Sans+SC:wght@400;500;700&family=JetBrains+Mono:wght@400;600&display=swap"},{"rel":"stylesheet","href":"https://unpkg.com/leaflet@1.9.4/dist/leaflet.css"}],"style":[],"script":[],"noscript":[],"title":"成都瑞纳致一 | Nuevos TEC - 链接全球，智启未来"};
