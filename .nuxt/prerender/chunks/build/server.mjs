import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, defineComponent, ref, inject, h, Suspense, Fragment, createApp, provide, shallowReactive, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, mergeProps, getCurrentScope, toRef, shallowRef, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/vue/index.mjs';
import { $fetch } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/ofetch/dist/node.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { createHooks } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/unctx/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/vue/server-renderer/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///root/.openclaw/workspace/nuevostec-web/node_modules/h3/dist/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B__dPvbO.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BmbpZS-s.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-bQu56N2o.mjs'));
